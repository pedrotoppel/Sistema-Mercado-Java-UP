...
public class ProdutoVestuarioView {

    private final ProdutoVestuarioController controller;
    private final CategoriaController categoriaController;
    private final FornecedorController fornecedorController;
    private final Leitura leitura;

    public ProdutoVestuarioView(Scanner scanner, ProdutoVestuarioController controller,
    ...
    private void cadastrar() {
        ...
        String tamanho = leitura.texto("Tamanho (P/M/G/GG): ");
        try {
            ProdutoVestuario p = controller.cadastrar(nome, preco, qtd, categoria, fornecedor, tamanho);
    ...
    private void listar() {
        List<ProdutoVestuario> produtos = controller.listar();
        if (produtos.isEmpty()) {
            System.out.println("Nenhum produto cadastrado.");
            return;
        }
        for (ProdutoVestuario p : produtos) {
            System.out.println(p + " | tamanho: " + p.getTamanho());
        }
    }
    ...
    private void alterar() {
        ...
        Categoria categoria = selecionarCategoria();
        Fornecedor fornecedor = selecionarFornecedor();
        String tamanho = leitura.texto("Novo tamanho: ");
        try {
            boolean ok = controller.alterar(id, nome, preco, qtd, categoria, fornecedor, tamanho);
